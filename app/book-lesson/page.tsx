...
export const metadata: Metadata = {
  ...
  description: `Schedule your NTSA-certified driving lesson with expert instructors. ${branches.length} locations, flexible scheduling, all-inclusive pricing. Book now - automatic & manual cars available.`,
...
export default function BookLessonPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-gray-900 to-red-600 text-white py-12 px-4">
